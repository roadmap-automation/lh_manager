...
racks={'Solvent': {'columns': 3, 'rows': 1, 'max_volume': 700.0, 'min_volume': 10.0, 'style': 'grid', 'height': 200, 'width': 900, 'x_translate': 0, 'y_translate': 0, 'shape': 'rect', 'editable': True},
       'Samples': {'columns': 4, 'rows': 15, 'max_volume': 2, 'min_volume': 0.1, 'style': 'grid', 'height': 800, 'width': 300, 'x_translate': 0, 'y_translate': 200, 'shape': 'circle', 'editable': True},
       'Stock':   {'columns': 2, 'rows': 7, 'max_volume': 40, 'min_volume': 0.5, 'style': 'grid', 'height': 800, 'width': 300, 'x_translate': 300, 'y_translate': 200, 'shape': 'circle', 'editable': True},
       'Mix':     {'columns': 4, 'rows': 20, 'max_volume': 8.5, 'min_volume': 0.15, 'style': 'staggered', 'height': 800, 'width': 300, 'x_translate': 600, 'y_translate': 200, 'shape': 'circle', 'editable': True},
